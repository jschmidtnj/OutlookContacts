...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(validateService, authService, router, flashMessage) {
    ...
    DashboardComponent.prototype.onRegisterSubmit = function () {
        ...
        // Register user
        this.authService.registerContact(contact).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Contact inputted!', { cssClass: 'alert-success', timeout: 3000 });
                //this.form.reset();
            }
            else {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onInputSubmit = function () {
        var _this = this;
        var contact = {
            name: this.name,
            email: this.email,
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerContact = function (contact) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('contacts/register', contact, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
    AuthService.prototype.findContacts = function (query) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        return this.http.get('contacts/getcontacts', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
...
module.exports = __webpack_require__(/*! /home/jschmidtnj/Desktop/contactsapp/angular-src/src/main.ts */"./src/main.ts");
